...
Install NixOS (only [this old version](https://releases.nixos.org/?prefix=nixos/23.05/nixos-23.05.997.ddf4688dc7a/) could install properly on my machine) with username ajit, and run these:
