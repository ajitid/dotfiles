...
^ Hopefully when I try next time, it'd just be condensed to cloning git repo, hey-init-nixos.sh and hey-sync-nix.sh but I'm not sure right now if in-between restarts are needed.
